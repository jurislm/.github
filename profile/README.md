...
| **[judicial-mcp](https://github.com/jurislm/judicial-mcp)** | 存取台灣司法院開放資料與裁判書的 MCP 伺服器 | `npx judicial-mcp@latest` |
| **[langfuse-mcp](https://github.com/jurislm/langfuse-mcp)** | Langfuse prompt 管理與可觀測性查詢的 MCP 伺服器 | `bunx @jurislm/langfuse-mcp@latest` |
